...
class ChatModel {
  ...
  List<String> getAllAvatars(CharacterController controller){
    return characterIds.map((id)=>controller.getCharacterById(id)).map((char)=>char.avatar).toList();
  }
  ...
  factory ChatModel.fromJson(Map<String, dynamic> json) {
    return ChatModel(
      ...
      prompts: (json['prompts'] as List?)?.map((e) => PromptModel.fromJson(e)).toList(),  // 新增解析
    ...
    )..mode = json['mode'] != null ? ChatMode.values.firstWhere(
  ...
  Map<String, dynamic> toJson() => {
        ...
        'requestOptions': requestOptions.toJson()..addAll({'max_history_length': requestOptions.maxHistoryLength}),
